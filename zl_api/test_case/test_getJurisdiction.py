...
test_data = DoExcel(project_path.case_path, 'create_getJurisdiction').read_excel('getJurisdictioncase')
My_log = Mylog()
token = None
@ddt
class TestCase(unittest.TestCase):
    def setUp(self):
        self.T = DoExcel(project_path.case_path, 'create_getJurisdiction')
